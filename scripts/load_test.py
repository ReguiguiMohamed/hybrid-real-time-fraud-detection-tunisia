...
class FraudDetectionLoadTester:
    ...
    def generate_transaction(self) -> Dict:
        ...
        transaction = {
            ...
            "governorate": random.choice([
                ...
                "Gabès", "Ariana", "Manouba", "Nabeul", "Zaghouan",
                "Ben Arous", "Medenine", "Tataouine", "Gafsa", "Tozeur",
                "Kasserine", "Sidi Bouzid", "Siliana", "Kebili", "Jendouba",
                "Beja", "Le Kef", "Mahdia", "Monastir", "Skanes"
            ]),
    ...
    def print_results(self):
        ...
        if self.stats['latencies']:
            ...
            p95_latency = sorted(self.stats['latencies'])[int(0.95 * len(self.stats['latencies']))] if self.stats['latencies'] else 0
